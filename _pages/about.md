...
redirect_from: 
  ...
  - /about.html
---
I am Research Scientist at Meta, working on data sub-sampling algorithms for Facebook Ads. Previously, I obtained my PhD in Computer Science (Machine Learning) at [UMass Amherst](https://www.cics.umass.edu/); my PhD research was on improving data selection efficiency with differentiable optimization layers.  During my PhD, I won the [NeurIPS 2020 education challenge](https://eedi.com/projects/neurips-education-challenge) for improving question selection efficiency in computerized adaptive tests (e.g., GRE, GMAT). During my PhD, I was able to squeeze in two research internships at [Adobe Research](https://research.adobe.com/), where I was fortunate to work on optimal bidding strategy in real-time bidding systems. Before my PhD, I was a Software Engineer (Applied Scientist) at [Microsoft BingAds](https://www.microsoft.com/en-in/msidc/bangalore-campus.aspx) where I had the opportunity to work on improving click performance and ad selection algorithms. Even before that, I had amazing years at the [Indian Institute of Science, Bangalore (IISc)](http://www.ee.iisc.ac.in/), where I worked on robust learning under noisy labels. I have been fortunate to work with some amazing researchers and publish in many exciting machine learning/data mining conferences and workshops such as AAAI, CVPR, ICML, IJCAI, KDD, and SIAM SDM. I also received the Best Student Paper Award from the [IEEE Big Data](https://bigdataieee.org/BigData2020/index.html) (2020) conference. 
